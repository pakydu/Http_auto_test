...
view source
view URL encoded
{"jsonrpc":"2.0","method":"GetReport","params":{"reporttype":"Comm", “subtype”:”SerialPort”,"stimedate":"19/11/2019 02:30:02","unitname":"Site Supervisor","unitversion":"2.12R22","sid":"95ff4ae1-c571-4ad8-bcd1-b20aaec31c90"},"id":"139"}
"""
def getReport(ip, sessionid):
        base_url="http://" + ip + "/cgi-bin/mgw.cgi"
        icnt = random.randint(1000,10000)   #"filter": ["CANBUS", "BACNETIP", "SERIAL"]
        param = '{"jsonrpc":"2.0","method":"RegisterPoint","params":{"points":[{"ptr":"31335166:AI01"},{"ptr":"31335166:AI02"},{"ptr":"31335166:DI01"}],"sid":"' + sessionid + '"},"id":"' + str(icnt) +'"}'
        print(param)
        print("\n\n");
        payload = {'m':param}
        try:
